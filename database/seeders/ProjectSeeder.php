    ...
    private function projects(): array
    {
        return [
            ...
            [
                ...
                'description' => 'In this application you will be able to create your own budgets, organize your clients and your inventory. All this with the advantage of being able to use it wherever you are.',
                'cover_url' => '/images/presupuestosMauri/portada.jpg',
                'cover_key' => null,
                'stack' => ['React.js', 'JavaScript', 'Redux', 'CSS', 'HTML', 'Passport.js', 'React Bootstrap'],
                'features' => [
                    'Create your user, save your owns budgets, clients and manage your inventory.',
                ],
                'tech_decisions' => null,
                'featured' => false,
                'published' => true,
